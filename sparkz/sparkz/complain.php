<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"><h1>Complaint</h1></li>
        </ol>
    </div><!--/.row-->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form"  data-toggle="validator" method="post" action="ajax.php">
                        ...
                        <button type="submit" class="btn btn-lg btn-primary" name="createComplaint" style="border-radius:0%">Submit</button>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    ?>
                    <table class="table table-striped table-responsive" cellspacing="0" width="100%" id="rooms">
                        <thead>
                        <tr>
                            <th>#</th>
